...
#********************************************************************
#      File:    DiagnosticsJson.py
#      Author:  Sam Strachan
#
#      Description:
#       Performs basic connection DiagnosticsJson without a full multi-process
...
class DiagnosticsJsonJson( object ):
    """DiagnosticsJson class helps find out what's going on"""
    ...
    def main():
        ...
        logger = estreamer.crossprocesslogging.StdOutClient(
            DiagnosticsJson.__name__,
            estreamer.crossprocesslogging.DEBUG)

        try:
            parser = argparse.ArgumentParser( description = 'Runs estreamer DiagnosticsJson' )
            parser.add_argument(
                'configFilepath',
            ...
            DiagnosticsJson = DiagnosticsJson( settings )
            DiagnosticsJson.execute()
